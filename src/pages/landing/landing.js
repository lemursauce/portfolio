    ...
    return (
        <div className="Landing">
            ...
            <Container fluid className="Hello Central" id="Home">
                ...
                <div className="AgainstBackground Central">
                    ...
                    <div className="socials">
                        <a href="https://github.com/lemursauce" aria-label="My GitHub account" title="My GitHub account" target="_blank">
                            <span class="iconify SocialIcon" data-icon="mdi:github" data-inline="false"/>
                        </a>
                        <a href="https://discordapp.com/users/657334339591471114" aria-label="My Discord account" title="My Discord account" target="_blank">
                            <span class="iconify SocialIcon" data-icon="ic:baseline-discord" data-inline="false"/>
                        </a>
                        <a href="https://www.linkedin.com/in/logan-a-carbo/" aria-label="My LinkedIn account" title="My LinkedIn account" target="_blank">
                            <span class="iconify SocialIcon" data-icon="mdi:linkedin" data-inline="false"/>
                        </a>
                        <a href="https://leetcode.com/u/lacarbo/" aria-label="My LeetCode account" title="My LeetCode account" target="_blank">
                            <span class="iconify SocialIcon" data-icon="simple-icons:leetcode" data-inline="false"/>
                        </a>
                        <a href="mailto:lacarbo05@gmail.com" aria-label="My Email account" title="My Email" target="_blank">
            ...
            <Container fluid className="AboutMe ContentAnchor" id="About">
                ...
                <Container>
                    <p>
                        I am a committed, self-driven, recent graduate from <a className="ManualLink" href="https://www.tamu.edu/" title="Texas A&M Homepage" aria-label="Link to Texas A&M Homepage" target="_blank">Texas A&M University</a> with a Bachelor of Science in Computer Science and a minor in Mathematics.
                    </p>
                    <p>
